    ...
    <main>
        <section class="registration-form">
            <form action="" method="POST">
                ...
                <input type="text" name="first_name" class="reg-input" placeholder="Křestní jméno" value="<?= htmlspecialchars(isset($_POST['first_name']) ? $_POST['first_name']:  '') ?>"><br />
                <input type="text" name="second_name" class="reg-input" placeholder="Příjmení" value="<?= htmlspecialchars(isset($_POST['second_name']) ? $_POST['second_name']:  '') ?>"><br />
                <input type="email" name="email" class="reg-input" placeholder="Email" value="<?= htmlspecialchars(isset($_POST['email']) ? $_POST['email']:  '') ?>"><br />

...
<head>
    ...
    <link rel="stylesheet" href="<?= ASSETS ?>css/admin/admin-edit-student.css" type="text/css"/>
    <link rel="stylesheet" href="<?= ASSETS ?>query/admin/edit-student-query.css" type="text/css"/>

...
<head>
    ...
    <link rel="stylesheet" href="<?= ASSETS ?>css/admin/delete-user.css" type="text/css"/>
            ...
            <section class="delete-form">
                ...
                <?php else: ?>
                    <form action="" method="POST">
                        ...
                        <p>Jste si jistí, že chcete smazat uživatele <?= htmlspecialchars($data['user']['first_name']) . " " . htmlspecialchars($data['user']['second_name']) ?>?</p>
                        <div class="btns">
                            <button>Smazat</button>
                            <a href="/user/user/<?= $data['user']['id'] ?>">Zrušit</a>
                        </div>
                    </form>
                <?php endif; ?>
            </section>
